...
// export let adminUrlAddr = "https://docker.dhdx.kr/senioredu";

export let kakaoRedirectUrlAddr = import.meta.env.VITE_KAKAO_REDIRECT_URL;
export let googleRedirectUrlAddr = import.meta.env.VITE_GOOGLE_REDIRECT_URL;

export let smartroSet = import.meta.env.VITE_SMARTRO_SET;
