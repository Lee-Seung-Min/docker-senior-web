...
<section class="contents">
  ...
  <div class="box_1">
    <dl class="info_dl">
      ...
      {:else}
        <dt class="wide">위 정보로 퀵을 신청 하시겠습니까?</dt>
      {/if}
    </dl>
  </div>

  <div class="btn_wrap inline">
    <button disabled={check} type="button" class="btn_01" value="퀵신청 하시겠습니까?" id="show" on:click={checkPopup}
      >퀵신청</button
    >
  </div>
</section>
<PopUp {popUp}>
  <slot
    >퀵신청 하시겠습니까? <button type="button" class="alert_close" on:click={xButton}
